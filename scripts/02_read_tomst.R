...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-09-13")))
probls <- c()
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-09-13")))
probls <- c(as_date(as_date("2022-05-10"):as_date("2022-10-03")))
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-09-13")))
probls <- c(as_date(as_date("2020-11-23"):as_date("2021-10-06")))
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-09-13")))
probls <- c(as_date(as_date("2021-06-27"):as_date("2022-10-03")))
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-09-13")))
probls <- c(as_date(as_date("2022-05-22"):as_date("2022-10-03")))
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-09-13")))
probls <- c(as_date(as_date("2021-05-10"):as_date("2021-10-06")))
hattu <- c()
